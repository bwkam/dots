...
in
{
  ...
  home.packages = with pkgs; [
    ...
    grapejuice
    zoom-us
    (lmms.overrideAttrs(final: prev: {
      src = fetchFromGitHub {
      owner = "LMMS";
      repo = "lmms";
       rev = "476a56e713bca22ce6760317de41176bff50610e";
        sha256 = "sha256-7K79SJuycr1KieezsmMG47r649IPXRROqL2BF/f91UA=";
      ...
      buildPhase = '' grep -i wine CMakeCache.txt '';
    }))
    protonvpn-gui
    audacity
    gnome.simple-scan
